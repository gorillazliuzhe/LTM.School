...
namespace LTM.School.EntityFramework.Data
{
    ...
    {
        public static void Initlize(SchoolDbContext context)
        {
            // 如果当前数据库不存在按照当前 model 创建，如果存在则不管了
            ...
            var students = new Student[] {
                ...
                new Student{ RealName="玩尼玛",EnrollmentDate=DateTime.Parse("2002-09-01")},
                ...
                new Student{ RealName="何琨",EnrollmentDate=DateTime.Parse("2002-09-01")},
